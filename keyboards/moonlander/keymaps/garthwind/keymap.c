...
#define WEBEXMUTE G(S(KC_M))

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_moonlander(
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL,            KC_INS,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS,
        ...
        SPECT,   KC_LCTL, KC_LALT, KC_LGUI, LOWER,            WEBEXMUTE,         _______, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
                                            KC_SPC,  C(KC_B), KC_LGUI,           KC_RALT, KC_TAB,  KC_SPC
    ),
    ...
    [_SPECT] = LAYOUT_moonlander(
        _______, _______, _______, _______, _______, _______, _______,           _______, _______, _______, _______, _______, _______, _______,
        _______, _______, SNAPTOP, _______, _______, _______, _______,           _______, _______, SNAPQ2,  SNAPQ1,  _______, _______, _______,
        _______, SNAPLFT, SNAPBOT, SNAPRGT, FULLSCR, _______, _______,           _______, _______, SNAPQ3,  SNAPQ4,  _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                             _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,          _______,           _______,          _______, _______, _______, _______, _______,
                                            _______, _______, _______,           _______, _______, _______
    ),
