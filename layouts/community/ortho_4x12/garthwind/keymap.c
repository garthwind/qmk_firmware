...
#define SPEC_TH G(A(KC_UP))
#define SPEC_BH G(A(KC_DOWN))
#define SPEC_LH G(A(KC_LEFT))
#define SPEC_RH G(A(KC_RGHT))
#define SPEC_FS G(A(KC_F))
#define SPC_LYR LT(_SPACEL, KC_SPC)
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,  _______, KC_PGUP, KC_PGDN, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),

/* Space Layer (Spectacles) 
 * ,-----------------------------------------------------------------------------------.
 * |      |      |Spec U|      |      | Vol+ |      | Ins  |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |Spec L|Spec D|Spec R|SpecFS| Vol- |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      | Mute |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
